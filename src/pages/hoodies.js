          ...
          <div className="container px-5 py-24 mx-auto">
            <div className="flex flex-wrap justify-center gap-5">
              <div className="lg:w-1/4 md:w-1/2 p-4 w-full shadow-xl">
                <Link href={'/products/wear-the-code-hoodies'}>
                  <div className="relative rounded overflow-hidden flex justify-center">
                    <img alt="ecommerce" className='object-contain h-[15rem]' src="https://m.media-amazon.com/images/I/517dxfcxRZL._SL1427_.jpg" />
                  </div>
              ...
              <div className="lg:w-1/4 md:w-1/2 p-4 w-full shadow-xl">
                <Link href={'/products/wear-the-code-hoodies'}>
                  <div className="relative rounded overflow-hidden flex justify-center">
                    <img alt="ecommerce" className='object-contain h-[15rem]' src="https://m.media-amazon.com/images/I/51Hz7KZL2TL._SL1427_.jpg" />
                  </div>
                  <div className="mt-4 text-center">
                    <h3 className="text-gray-500 text-xs tracking-widest title-font mb-1">T-Shirt</h3>
                    <h2 className="text-gray-900 title-font text-lg font-medium">Wear The Code</h2>
