    ...
    <>
      ...
      <main>
        <section id="bannerArea">
          <Image src={require('../assets/img/tshirt.png')} layout="responsive" alt="" width={'100'} height={'100'} />
        </section>

        <section className="text-gray-600 body-font">
          <div className="container px-5 py-24 mx-auto">
            <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
              <h1 className="sm:text-3xl text-2xl font-black title-font mb-5 text-rose-900 capitalize border-b-4 border-rose-900 px-2">Wear your fav cloth with codeswear</h1>
              <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Wear whatever yout want? What do you want? You want code? So why not wear the code?</p>
            </div>
