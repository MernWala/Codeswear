                    ...
                    <div className="container px-5 py-24 mx-auto">
                        <div className="flex flex-wrap justify-center gap-5">
                            <div className="lg:w-1/4 md:w-1/2 p-4 w-full shadow-xl">
                                <Link href={'/products/wear-the-code-watch'}>
                                    <div className="relative rounded overflow-hidden flex justify-center">
                                        <img alt="ecommerce" className='object-contain h-[15rem]' src="https://m.media-amazon.com/images/I/613Ay8pU9zL._SL1486_.jpg" />
                                    </div>
